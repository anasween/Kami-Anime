...
class BsPager extends CBasePager
{
     ...
     */
    public $nextPageLabel = '<span class="glyphicon glyphicon-arrow-right"></span> Вперед';
    /**
     * @var string the text label for the previous page button.
     */
    public $prevPageLabel = 'Назад <span class="glyphicon glyphicon-arrow-left"></span>';
    /**
     * @var string the text label for the first page button.
     */
    public $firstPageLabel = 'В начало';
    /**
     * @var string the text label for the last page button.
     */
    public $lastPageLabel = 'В конец';
