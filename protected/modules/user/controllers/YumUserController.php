    ...
    public function accessRules() {
        return array(
            ...
            array('allow',
                ...
                'expression' => 'Yii::app()->user->can("user", "update")'
            ),
            array('allow',
                'actions' => array('create'),
                'expression' => 'Yii::app()->user->can("user", "create")'
            ),
            array('allow',
                'actions' => array('admin'),
                'expression' => 'Yii::app()->user->can("user", "admin")'
            ),
            array('allow',
                'actions' => array('delete'),
                'expression' => 'Yii::app()->user->can("user", "delete")'
            ),
            ...
            if (isset($_POST['YumUserChangePassword'])) {
                if ($_POST['YumUserChangePassword']['password'] == '') {
                    ...
                    $password = EPasswordGenerator::generate(
                                    $generatorOptions['length'], $generatorOptions['capitals'], $generatorOptions['numerals'], $generatorOptions['symbols']);
